...
[
	...
	"(player getVariable ['vn_mf_db_player_group', 'MikeForce'] in ['MilitaryPolice', 'DacCong']) && player distance cursorTarget <= 5 && primaryWeapon player != "" &&{ vehicle player isEqualTo player && {cursorTarget isKindOf 'Man' && {alive cursorTarget}}}",	// Condition for the action to be shown
